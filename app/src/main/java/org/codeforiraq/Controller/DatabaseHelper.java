...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public  long insertData(Data data){
        ...
        cv.put(Utils.COLOUMN_JOB , data.getJob());
    ...
    public  Data getData(int id) {
        ...
        Cursor cursor = db.query(Utils.TABLE_NAME,
                new String[]{Utils.COLOUMN_ID,
                        Utils.COLOUMN_NAME,Utils.COLOUMN_JOB
                        ,Utils.COLOUMN_phone,
    ...
    public List<Data> getAllData() {
        ...
        if(cursor.moveToFirst())
          do{
              ...
              data.setJob( cursor.getString(cursor.getColumnIndex(Utils.COLOUMN_JOB)));
              data.setTimeStamp(cursor.getString(cursor.getColumnIndex(Utils.COLOUMN_TIME_STAMP)));
              data.setPhone( cursor.getString(cursor.getColumnIndex(Utils.COLOUMN_phone)));
